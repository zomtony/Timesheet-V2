...
public class TimesheetRow implements java.io.Serializable {
    ...
    /**
     * Creates a TimesheetDetails object and sets the editable state to true.
     * @param workPackage as String 
     * @param projectID as int 
     * @param hoursForWeek as BigDecimal array 
     * @param notes as String 
     */
    public TimesheetRow(String workPackage, 
            int projectID,  BigDecimal[] hoursForWeek, String notes) {
  ...
  public void setHour(final int day, final double hour) {
    ...
    /**
     * Sets the sum for this TimesheetRow.
